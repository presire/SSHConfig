...
Item {
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    Label {
                        ...
                        font.italic: true
                        font.pointSize: 14 + selectDirectory.fontPadding
    ...
    Row {
        ...
        anchors.leftMargin: Math.round((selectDirectory.width - (btnselect.width + btnBack.width + btnCancel.width + 60)) / 2 - 20 - btnUpDirectory.width)
