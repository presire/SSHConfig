...
//        anchors.rightMargin: 20
        ...
        Label {
            id: labelPath
            text: ""
            font.pointSize: 10 + select.fontPadding
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    Image {
                        id: iconType
                        source: model.file === 0 ? "qrc:/Image/File.png" : "qrc:/Image/Directory.png"
                        width: 48
                        height: 48
                        fillMode: Image.Stretch
...
//                            }
    ...
    Row {
        id: rowBtn
        spacing: select.width >= 875 ? 30 : 20

        anchors.top: select.width >= 875 ? frameList.bottom : btnUpDirectory.bottom
        anchors.topMargin: 10
        ...
        Button {
            id: btnselect
            text: qsTr("Select")
            implicitWidth: select.width >= 875 ? 150 : 100
            implicitHeight: 50
