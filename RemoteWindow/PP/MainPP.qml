...
ApplicationWindow {
    ...
    width: viewWidth
    height: viewHeight
//    minimumWidth: viewWidth
//    minimumHeight: viewHeight
    visible: true
    ...
    Component.onCompleted: {
        authView = mainView.push("AuthPP.qml", {parentName: remoteWindow,
    ...
    onNextViewChanged: {
        if (bDirectory === false) {
            ...
            selectView = mainView.push("SelectPP.qml", {parentName: remoteWindow,
                                       // Window settings.
            ...
            // Next view (Select Window).
            selectView = mainView.push("SelectDirectoryPP.qml", {parentName: remoteWindow,
                                       // Window settings.
                                       viewWidth: remoteWindow.viewWidth, viewHeight: remoteWindow.viewHeight, bDark: remoteWindow.bDark,
