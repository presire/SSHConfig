        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Label {
                    id: hostLabel
                    text: qsTr("Host Name :")
                    font.pointSize: 14 + authForSSHService.fontPadding
            ...
            RowLayout {
                ...
                RoundButton {
                    ...
                    icon.source: pressed ? "Image/KeyFileButtonPressed.png" : "Image/KeyFileButton.png"
                    icon.width: width
                    icon.height: height
