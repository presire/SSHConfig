...
ApplicationWindow {
    ...
    Component.onCompleted: {
        passwordDialog.title = qsTr("Permission denied")
    }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Label {
                        text: qsTr("You must have read permission to read this file.") + "<br>" +
                              qsTr("Would you like to enter the administrator password and read with administrator privileges?") + "<br><br>" +
