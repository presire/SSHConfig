    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                text: qsTr("Allow Kerberos authentication :") + "<br>" + "(KerberosAuthentication)"
            ...
            // GSSAPI settings.
            Label {
                text: qsTr("GSS-API (Generic Security Services API) Authentication")
            ...
            Label {
                ...
                text: qsTr("Authenticate using GSSAPI :") + "<br>" + "(GSSAPIAuthentication)"
                font.pointSize: 12 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Delete authenticate cache when logout :") + "<br>" + "(GSSAPICleanupCredentials)"
                font.pointSize: 12 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Strictly check GSSAPI acceptors :") + "<br>" + "(GSSAPIStrictAcceptorCheck)"
                font.pointSize: 12 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Key exchange to allow GSSAPI :") + "<br>" + "(GSSAPIKeyExchange)"
                font.pointSize: 12 + root.fontPadding
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    text: qsTr("Specify algorithm for key exchange in GSSAPI :") + "<br>" +
                          "(GSSAPIKexAlgorithms)"
                    font.pointSize: 12 + root.fontPadding
                ...
                ComboBox {
                    ...
                    model: ListModel {
                        ...
                        ListElement { text: "gss-group1-sha1-*" }
                    }
