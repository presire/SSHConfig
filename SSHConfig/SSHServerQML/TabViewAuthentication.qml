...
Item {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Label {
                id: permitRootLabel
                text: qsTr("Allow root login :") + " (PermitRootLogin)"
            ...
            Label {
                ...
                text: qsTr("Retry Maximum number of authentication :") + " (MaxAuthTries)"
                font.pointSize: 14 + root.fontPadding
            ...
            TextField {
                id: maxAuthTriesEdit
                text: ""
                implicitWidth: Math.round((root.viewWidth - authenticationColumn.spacing * 2) * 0.2)
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: maxSessionsLabel
                text: qsTr("Maximum simultaneous connections :") + " (MaxSessions)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                text: qsTr("Specifies the maximum number of shell, login, subsystem(e.g. sftp) sessions permitted per network connection.") + "<br><br>" +
            ...
            Label {
                ...
                text: qsTr("Allow password authentication :") + " (PasswordAuthentication)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow login for accounts with empty passwords :") + " (PermitEmptyPasswords)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow public key authentication :") + " (PubkeyAuthentication)"
                font.pointSize: 14 + root.fontPadding
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Label {
                        ...
                        text: qsTr("Path to public key file stored on SSH server :") + " (AuthorizedKeysFile)"
                        font.pointSize: 14 + root.fontPadding
                    ...
                    RoundButton {
                        ...
                        onClicked: {
                            ...
                            else                  sshServerConfig.getAuthorizedKeyFile(root.width, root.height, root.bDark, root.fontPadding)
                        }
            ...
            Label {
                ...
                text: qsTr("Specify command used to get public key :") + "<br>" +
                      "(AuthorizedKeysCommand)"
                font.pointSize: 14 + root.fontPadding
            ...
            TextField {
                ...
                text: ""
                implicitWidth: Math.round((root.viewWidth - authenticationColumn.spacing * 2) * 0.6)
                font.pointSize: 14 + root.fontPadding
            ...
            TextField {
                ...
                text: ""
                implicitWidth: Math.round((root.viewWidth - authenticationColumn.spacing * 2) * 0.3)
                font.pointSize: 14 + root.fontPadding
                placeholderText: qsTr("default is none")
            ...
            Label {
                text: qsTr("Allow keyboard interactive authentication.") + "<br>" +
                      qsTr("All authentication in login.conf is supported.") + "<br><br>" +
            ...
            Label {
                text: qsTr("If set to yes, either \"PasswordAuthentication\" or \"ChallengeResponseAuthentication\" must be set to yes.") + "<br><br>" +
            ...
            Label {
                ...
                text: qsTr("Public key authentication option :") + " (PubkeyAuthOptions)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Hash algorithm used when logging fingerprint :") + " (FingerprintHash)"
                font.pointSize: 14 + root.fontPadding
