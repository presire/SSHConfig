        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                TextField {
                    id: portEdit
                    text: ""
                    implicitWidth: Math.round((root.viewWidth - portLabel.width - tabGeneralColumn.spacing * 2 - portRow.spacing) * 0.35)
                    font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Protocols that allow connections :") + " (AddressFamily)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Session key regeneration :") + " (RekeyLimit)"
                font.pointSize: 14 + root.fontPadding
                wrapMode: Label.WordWrap
            ...
            RowLayout {
                ...
                TextField {
                    id: rekeyLimitEdit
                    text: ""
                    implicitWidth: Math.round((root.viewWidth - tabGeneralColumn.spacing * 2 - rekeyLimitRow.spacing) * 0.35)
                    font.pointSize: 14 + root.fontPadding
            ...
            RowLayout {
                ...
                TextField {
                    ...
                    implicitWidth: Math.round((root.viewWidth - tabGeneralColumn.spacing * 2 - rekeyLimitTimeRow.spacing) * 0.2)
                    text: ""
                    font.pointSize: 14 + root.fontPadding
                    placeholderText: ""
            ...
            // "HostKey" and "ListenAddress"
            GridLayout {
                width: parent.width
                rows: 1
                columns: 2
                columnSpacing: root.viewWidth * 0.1 - 40
                    ...
                    RowLayout {
                        ...
                        RoundButton {
                            ...
                            onClicked: {
                                ...
                                else                  sshServerConfig.getHostKeyFile(root.width, root.height, root.bDark, root.fontPadding)
                            }
            ...
            Label {
                ...
                text: qsTr("Facility for log messages output to syslog server :") + " (SyslogFacility)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: labelLogLevel
                text: qsTr("Level of log output by sshd :") + " (LogLevel)"
                font.pointSize: 14 + root.fontPadding
            ...
            RowLayout {
                ...
                TextField {
                    ...
                    text: ""
                    implicitWidth: Math.round((root.viewWidth - loginGraceTimeLabel.width - tabGeneralColumn.spacing * 2 - loginGraceTimeRow.spacing) * 0.5)
                    font.pointSize: 14 + root.fontPadding
                    placeholderText: ""
