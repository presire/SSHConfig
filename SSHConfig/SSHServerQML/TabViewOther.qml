    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                text: qsTr("Allow agent forwarding by ssh-agent :") + " (AllowAgentForwarding)"
            ...
            Label {
                ...
                text: qsTr("Allow TCP forwarding :") + " (AllowTcpForwarding)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow port relay :") + " (GatewayPorts)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow X11 transfer :") + " (X11Forwarding)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Display number used for X11 transfers :") + " (X11DisplayOffset)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow X11 on localhost only :") + " (X11UseLocalhost)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: permitTTYLabel
                text: qsTr("Allow pty allocation :") + " (PermitTTY)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: printMotdLabel
                text: qsTr("Display contents of /etc/motd at login :") + " (PrintMotd)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Send TCP keep-alive message :") + " (TCPKeepAlive)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow users to change environment variables :") + " (PermitUserEnvironment)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: compressionLabel
                text: qsTr("Allow compression :") + " (Compression)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Interval to check for client :") + " (ClientAliveInterval)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: useDNSLabel
                text: qsTr("Check remote server name using DNS :") + " (UseDNS)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                id: pidFileLabel
                text: qsTr("Path to PID file for SSH :") + " (PIDFile)"
                font.pointSize: 14 + root.fontPadding
            ...
            RoundButton {
                ...
                onClicked: {
                    ...
                    else                  sshServerConfig.getRemoteDirectory(root.width, root.height, root.bDark, root.fontPadding, 0)
                }
            ...
            TextField {
                id: pidFileEdit
                text: ""
                implicitWidth: Math.round((root.viewWidth - otherColumn.spacing * 2) * 0.5)
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                text: qsTr("Ex. In the case of 10:30:100, if there are start(10) unauthenticated connections,") + "<br>" +
            ...
            TextField {
                id: maxStartupsEdit
                text: ""
                implicitWidth: Math.round((root.viewWidth - otherColumn.spacing * 2) * 0.3)
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Allow tunneling :") + " (PermitTunnel)"
                font.pointSize: 14 + root.fontPadding
            ...
            Label {
                ...
                text: qsTr("Path to directory for chroot :") + " (ChrootDirectory)"
                font.pointSize: 14 + root.fontPadding
            ...
            RoundButton {
                ...
                onClicked: {
                    ...
                    else                  sshServerConfig.getRemoteDirectory(root.width, root.height, root.bDark, root.fontPadding, 1)
                }
            ...
            Label {
                id: bannerLabel
                text: qsTr("String to be displayed when session is established :") + " (Banner)"
                font.pointSize: 14 + root.fontPadding
            ...
            TextArea {
                id: bannerEdit
                text: ""
                implicitWidth: Math.round((root.viewWidth - otherColumn.spacing * 2) * 0.8)
                font.pointSize: 14 + root.fontPadding
                placeholderText: qsTr("default is none")
            ...
            Label {
                ...
                text: qsTr("Text to append to SSH protocol banner sent when connecting :") + " (VersionAddendum)"
                font.pointSize: 14 + root.fontPadding
